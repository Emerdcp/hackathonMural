    ...
    <section class="hero">
        <div class="overlay">
            <div class="container">
                ...
                <a class="btn btn-outline-secondary" onclick="abrirCadastro()">Cadastrar</a>
            </div>
        </div>
    </section>
        ...
        <div class="modal-conteudo">
            ...
            <form id="formCadastrar">
                <div class="row">
                    <div class="col-md-12">
                        <label for="nome" class="form-label">Nome</label>
                        <input type="text" class="form-control" id="nomeUsuario" name="nome" placeholder="Digite seu nome" maxlength="80"
                            required>
                    </div>
                    <div class="col-md-12">
                        <label for="email" class="form-label">E-mail</label>
                        <input type="email" class="form-control" id="emailUsuario" name="email" placeholder="Digite seu e-mail"
                            maxlength="100" required>
                    </div>
                    <div class="col-md-12">
                        <label for="telefone" class="form-label">Telefone</label>
                        <input type="text" class="form-control" id="telefoneUsuario" name="telefone" placeholder="Digite seu telefone"
                            maxlength="20" required>
                    </div>
                    <div class="col-md-12">
                        <label for="titulo" class="form-label">Senha</label>
                        <input type="password" class="form-control" id="senha" name="senha" required minlength="6" placeholder="Digite sua senha" maxlength="255" required>
                    </div>
                    <div class="col-md-12">
                        <label for="titulo" class="form-label">Senha</label>
                        <input type="password" class="form-control" id="confirmaSenha" name="confirmaSenha" required minlength="6" placeholder="Digite sua senha" maxlength="255" required>
                    </div>
                    <input type="hidden" name="st_registro" value="A">
                    <div id="erroSenha" class="text-danger small d-none">As senhas não coincidem!</div>
                    <div class="d-flex gap-2 mt-3">
                        <button type="submit" class="btn btn-primary flex-fill">Salvar</button>
                        <button type="button" class="btn btn-secondary flex-fill" onclick="fecharInserir('modalInserir')">Cancelar</button>
                    </div>
                    <div id="alerta" class="alerta sucesso d-none">Usuário inserido com sucesso!</div>
                </div>
            </form>
        </div>
    </div>
